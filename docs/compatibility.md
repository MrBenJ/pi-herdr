...
| TypeBox | `1.3.7` |
| Development runtime | Node, npm per `engines.node >=22.19.0`; Vitest `5.0.0` |
...
- `pane rename`/`agent rename` accept `--clear` as an option; when clearing, no name operand is emitted.
